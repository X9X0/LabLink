...
class TriggerConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "level": self.level,
            "edge": (
                self.edge.value if isinstance(self.edge, Enum) and self.edge else None
            ),
...
class AcquisitionConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "export_format": (
                ...
                if isinstance(self.export_format, Enum)
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AcquisitionConfig":
        ...
        trigger_config = (
            TriggerConfig.from_dict(trigger_data) if trigger_data else TriggerConfig()
        )

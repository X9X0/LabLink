...
results.append(check_code_contains(
    ".env.example",
    ["LABLINK_ENABLE_SAFETY_LIMITS", "LABLINK_ENFORCE_SLEW_RATE",
     "LABLINK_SAFE_STATE_ON_DISCONNECT", "LABLINK_EMERGENCY_STOP_TIMEOUT_SEC"],
...
results.append(check_code_contains(
    ...
    ["activate_emergency_stop", "deactivate_emergency_stop",
     "get_emergency_stop_status", "get_safety_status", "get_safety_events"],
...
results.append(check_code_contains(
    "api/__init__.py",
    ["safety_router"],
    "API __init__ exports safety_router"
))
...
results.append(check_code_contains(
    "equipment/bk_power_supply.py",
    ["emergency_stop_manager.is_active()", "safety_validator.check_voltage",

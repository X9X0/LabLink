...
results.append(check_code_contains(
    ".env.example",
    ["LABLINK_ENABLE_STATE_MANAGEMENT", "LABLINK_STATE_DIR",
     "LABLINK_ENABLE_STATE_PERSISTENCE", "LABLINK_ENABLE_STATE_VERSIONING"],
...
results.append(check_code_contains(
    "api/state.py",
    ["compare_states"],
    "State API contains comparison endpoint"
))
...
results.append(check_code_contains(
    "api/__init__.py",
    ["state_router"],
    "API __init__ exports state_router"
))
...
results.append(check_code_contains(
    "main.py",
    ["from equipment.state import state_manager", "state_manager.set_state_directory"],

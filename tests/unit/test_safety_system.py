...
def main():
    """Run the checks as a script.

    This body used to sit at module level, so pytest executed it on
    import -- during collection, before any test ran. That made a
    sys.exit() here an INTERNALERROR that aborted the whole session,
    and any side effect here a side effect of merely collecting.
    """
    print("="*70)
